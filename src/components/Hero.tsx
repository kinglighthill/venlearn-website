  ...
  return (
    <section className="relative pt-48 pb-32 overflow-hidden bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          Secure. Scalable. <br />
          <span className="text-slate-900">Uncompromised.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-xl md:text-xl text-slate-500 max-w-2xl mx-auto mb-12 leading-relaxed font-medium"
        >
        ...
        >
          ...
          <Link
            href="/contact"
            className="px-10 py-4.5 rounded-2xl bg-white border border-slate-200 text-slate-700 font-bold text-lg hover:bg-slate-50 hover:border-slate-300 transition-all hover:scale-[1.02] active:scale-95 shadow-sm"
          >
            Request Demo
          </Link>
        </motion.div>
       ...
       <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none -z-10">
          ...
          <div className="absolute top-[20%] right-[-5%] w-[30%] h-[30%] bg-orange-50/50 rounded-full blur-3xl opacity-60" />
       </div>
    </section>
  );
}
