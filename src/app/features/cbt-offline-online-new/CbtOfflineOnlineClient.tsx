...
const cbtFeature = getProductFeature("cbt-offline-online");
const includedCapabilities = cbtFeature?.subFeatures ?? [];
const otherFeatures = productFeatures.filter((item) => item.slug !== "cbt-offline-online");
...
const suiteApps = [
  {
    ...
    highlights: ["Real-time logging", "Secure socket connections", "Exam distribution"],
  },
  {
    id: "manager",
    name: "Admin",
    ...
    highlights: ["Candidate management", "Live proctoring view", "Result analytics"],
  },
  {
    id: "editor",
    name: "Editor",
...
const walkthrough = {
  ...
  description: "A short guide to authoring your first exam, from blank page to question bank.",
  duration: "5:30",
  videoUrl: "https://venlearn.fra1.cdn.digitaloceanspaces.com/editor/videos/overview.mp4",
};
...
function SuiteSwitcher() {
  ...
  return (
    <div className="mx-auto mt-14 max-w-6xl">
      ...
      <p className="mt-5 text-center text-sm font-bold text-[#667085]" aria-live="polite">
      ...
      {isPlaying ? (
        ...
        >
          ...
          <span className="absolute bottom-0 inset-x-0 flex flex-col gap-1 bg-gradient-to-t from-black/70 to-transparent p-6 text-left sm:p-8">
            <span className="text-lg font-black text-white sm:text-xl">{walkthrough.title}</span>
...
export default function CbtOfflineOnlineClient() {
  return (
    <div className="overflow-hidden bg-white px-5 pb-24 pt-32 text-[#101828] sm:px-8 lg:px-10">
      ...
      <section className="mx-auto max-w-7xl text-center">
        ...
        <p className="mx-auto mt-7 max-w-3xl text-lg font-medium leading-8 text-[#667085] sm:text-2xl sm:leading-10">
          Run computer-based tests in school or remotely with question banks, timing, grading,
          result summaries, MS Word imports, and online result publishing.
        </p>
      ...
      <section className="mx-auto mt-24 max-w-7xl">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-sm font-black uppercase tracking-[0.24em] text-[#2661ac]">The suite</p>
          ...
          <p className="mt-5 text-base font-medium leading-7 text-[#667085] sm:text-lg">
            Each app does one job and shares the same exam data, so nothing is retyped between
            authoring, delivery, sitting, and marking.
          </p>
        </div>
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-2">
          {suiteApps.map((app) => (
            ...
            >
              ...
              <h3 className="mt-5 text-2xl font-black leading-tight text-[#101828]">{app.title}</h3>
              <p className="mt-3 text-sm font-semibold leading-6 text-[#667085]">{app.description}</p>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          <div className="rounded-[1.75rem] bg-[#101828] p-6 text-white shadow-2xl shadow-[#101828]/20 sm:p-8">
            ...
            <p className="mt-5 text-base font-medium leading-7 text-white/70">
              Each function is connected to the same permissions, reporting, communication, and
              records layer, so teams can work without jumping across disconnected tools.
            </p>
          </div>
            ...
            return (
              ...
              >
                <div className={imageFirst ? "lg:order-2" : undefined}>
                  ...
                  <p className="mt-4 text-base font-medium leading-7 text-[#667085]">{step.body}</p>
                  <ul className="mt-6 space-y-3">
                    {step.points.map((point) => (
                      <li key={point} className="flex gap-3">
                        ...
                        <p className="text-sm font-bold leading-6 text-[#344054]">{point}</p>
                      </li>
                    ))}
                  </ul>
                </div>
      ...
      <section id="walkthrough" className="mx-auto mt-24 max-w-7xl scroll-mt-28">
        <div className="rounded-[2rem] bg-[#101828] p-6 shadow-2xl shadow-[#101828]/20 sm:p-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-base font-medium leading-7 text-white/70">
              Watch a short walkthrough of the exam-authoring flow, then explore the rest of the
              suite on our channel.
            </p>
          </div>
          ...
          <div className="mx-auto mt-8 flex max-w-4xl flex-col items-center justify-between gap-4 rounded-[1.35rem] border border-white/10 bg-white/5 p-6 sm:flex-row">
            <p className="text-center text-sm font-bold text-white/80 sm:text-left">
              More tutorials, feature overviews, and release walkthroughs on YouTube.
            </p>
            <a
      ...
      <section id="download" className="mx-auto mt-24 max-w-7xl scroll-mt-28">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-sm font-black uppercase tracking-[0.24em] text-[#2661ac]">Download</p>
          <h2 className="mt-3 text-4xl font-black leading-tight text-[#101828] sm:text-5xl">
            Install the suite on your exam machines.
          </h2>
          <p className="mt-5 text-base font-medium leading-7 text-[#667085] sm:text-lg">
            Windows installers are available today; macOS and Linux are coming soon. Not sure what
            you need? The Suite installer includes everything.
          </p>
        </div>
          ...
          {downloads.map((app) => (
            ...
            >
              <div className="relative mx-auto h-16 w-16">
                <Image src={app.icon} alt={`${app.name} app icon`} fill className="object-contain" />
              </div>
              <h3 className="mt-4 text-base font-black leading-6 text-[#101828]">{app.name}</h3>
              ...
              <p className="mt-3 text-xs font-bold text-[#98a2b3]">macOS &amp; Linux coming soon</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="mx-auto mt-24 max-w-7xl">
        <div className="rounded-[2rem] border border-[#eef2f7] bg-[#f8fafc] p-8 text-center sm:p-14">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base font-medium leading-7 text-[#667085] sm:text-lg">
            Book a walkthrough with our team, or download the apps and set up your first
            computer-based test today.
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/book-demo"
