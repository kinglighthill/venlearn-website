  ...
  return (
    <div className="bg-white px-5 pb-24 pt-32 sm:px-8 lg:px-10">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-10 grid gap-4">
          {terms.map(([title, body], index) => (
            <section key={title} className="rounded-[1.5rem] border border-[#eaecf0] bg-white p-6 shadow-sm">
              <p className="text-sm font-black uppercase tracking-[0.2em] text-[#2661ac]">0{index + 1}</p>
        ...
        <Link href="/book-demo" className="mt-10 inline-flex min-h-14 items-center justify-center gap-2 rounded-full bg-[#101828] px-7 py-4 font-black text-white">
          Ask about terms
