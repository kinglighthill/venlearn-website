...
export const metadata: Metadata = createPageMetadata({
  title: "Partner Signup Received",
  description: "Your Venlearn partner signup has been received.",
  ...
  return (
    <div className="relative overflow-hidden bg-white px-5 pb-24 pt-32 sm:px-8 lg:px-10">
      ...
      <section className="mx-auto max-w-4xl text-center">
        ...
        <p className="mt-8 text-sm font-black uppercase tracking-[0.24em] text-[#2661ac]">
          Partner signup received
        </p>
        <h1 className="mx-auto mt-4 max-w-3xl text-5xl font-black leading-[0.96] tracking-normal text-[#101828] sm:text-7xl">
          Thanks. Your Venlearn partner request is in the queue.
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg font-medium leading-8 text-[#667085] sm:text-xl">
          We have received your partner signup. A Venlearn team member will
          reach out to discuss the referral process, commission details, and
          next steps.
        </p>

        <div className="mx-auto mt-10 grid max-w-2xl gap-3 sm:grid-cols-2">
          {["A team member will reach out", "Your request has been saved"].map(
            (item) => (
              <div
                key={item}
                className="flex items-center gap-3 rounded-2xl border border-[#e8e9f4] bg-white p-4 text-left shadow-xl shadow-[#101828]/5"
              >
